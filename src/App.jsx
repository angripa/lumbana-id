...
const WA = "https://wa.me/6281213694363";
const TEL = "tel:+6281213694363";
const PHONE = "0812-1369-4363";
...
const MENU = [
  {
    name: "Arsik",
    desc: "Ikan mas berbumbu lengkuas dan andaliman — hidangan wajib upacara adat Batak Toba.",
    badge: "Wajib Adat",
    bg: "#fff8ee",
  },
  {
    name: "Saksang",
    desc: "Masakan daging pilihan dengan bumbu rempah khas dan andaliman yang kaya rasa.",
    badge: "Favorit",
    bg: "#fff2e8",
  },
  {
    name: "Ayam Napinadar",
    desc: "Ayam panggang dengan saus bumbu spesial khas Batak yang menggugah selera.",
    badge: "Spesial",
    bg: "#fff8ee",
  },
  {
    name: "Dengke Naniarsik",
    desc: "Ikan masak kuah kuning aromatik dengan rempah pilihan khas Tanah Batak.",
    badge: "",
    bg: "#fff2e8",
  },
  {
    name: "Daun Singkong Tumbuk",
    desc: "Sayuran khas yang dimasak dengan santan dan bumbu Batak pilihan.",
    badge: "",
    bg: "#fff8ee",
  },
  {
    name: "Menu Nusantara",
    desc: "Rendang, Ayam Bakar, Soto Betawi, dan masakan nasional favorit keluarga.",
    badge: "Tersedia",
    bg: "#fff2e8",
  },
];
...
const STEPS = [
  {
    ...
    text: "Ceritakan kebutuhan acara, jumlah tamu, dan tanggal pelaksanaan.",
  },
  {
    num: "02",
    title: "Diskusi Menu & Paket",
    text: "Kami bantu susun menu terbaik sesuai selera, adat, dan anggaran.",
  },
  {
    num: "03",
    title: "Konfirmasi & DP",
    text: "Proses pembayaran aman dan transparan. Pesanan terkonfirmasi setelah DP.",
  },
  {
    num: "04",
    title: "Terima di Hari H",
    text: "Makanan diantarkan tepat waktu, panas, dan siap saji untuk tamu Anda.",
  },
];

const TESTIMONIALS = [
  {
    name: "Martogi Siahaan",
    role: "Pernikahan Adat Batak",
    text: "Arsik dan Saksangnya benar-benar autentik! Semua tamu memuji cita rasanya. Lumbana jadi pilihan utama kami untuk setiap acara keluarga besar.",
    rating: 5,
  },
  {
    name: "Rotua Nababan",
    role: "Acara Syukuran",
    text: "Responsif dan profesional. Kami pesan mendadak 2 hari sebelum acara dan semua berjalan sangat lancar. Sangat direkomendasikan!",
    rating: 5,
  },
  {
    name: "Parulian Hutapea",
    role: "Acara Adat Marhusip",
    text: "Sudah 3 kali memakai Lumbana untuk acara adat keluarga. Konsisten enak, porsi pas, selalu tepat waktu. Tidak akan pindah ke catering lain!",
    rating: 5,
  },
];
...
const FAQS = [
  {
    q: "Apakah bisa pesan untuk acara mendadak?",
    a: "Bisa, selama slot produksi masih tersedia. Hubungi WhatsApp kami untuk pengecekan cepat. Kami usahakan membantu kebutuhan mendadak Anda semaksimal mungkin.",
  },
  {
    q: "Berapa minimal pesanan?",
    a: "Minimal pesanan mulai dari 50 porsi. Untuk acara skala kecil, silakan konsultasikan terlebih dahulu agar kami dapat menyesuaikan kebutuhan Anda.",
  },
  {
    q: "Apakah hanya melayani masakan Batak?",
    a: "Tidak. Kami juga melayani masakan nasional seperti rendang, ayam bakar, soto, dan berbagai menu nusantara lainnya sesuai kebutuhan acara.",
  },
  {
    q: "Area layanan Lumbana Catering di mana saja?",
    a: "Fokus layanan kami di Jakarta Timur dan sekitarnya. Untuk lokasi di luar area tersebut, silakan konsultasi terlebih dahulu untuk ketersediaan.",
  },
  {
    q: "Apakah ada survei lokasi sebelum hari H?",
    a: "Untuk acara besar kami bisa melakukan survei lokasi. Diskusikan detail ini saat konsultasi menu agar semua kebutuhan teknis dapat kami persiapkan.",
  },
];

function Stars({ count = 5 }) {
  return (
    <div className="stars" aria-label={`Rating ${count} dari 5`}>
      {"★".repeat(count)}
    </div>
  );
}
      ...
      <main id="konten-utama">
          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              ...
              <div className="cta-group">
                ...
                <a className="btn btn-outline-white" href={TEL}>
                  📞 {PHONE}
                </a>
              </div>
            </div>
          ...
          <div className="container">
            <div className="section-head reveal">
              ...
              <p className="section-intro">
                Dari upacara adat Batak yang sakral hingga pesta keluarga yang meriah — semua kami layani
                dengan sepenuh hati.
              </p>
            </div>
        ...
        <section id="menu" className="section section-warm">
          <div className="container">
            <div className="section-head reveal">
              ...
              <p className="section-intro">
                Masakan kami dibuat dengan resep turun-temurun dan rempah pilihan dari Tanah Batak Toba.
              </p>
            </div>
            <div className="menu-grid">
              {MENU.map((item, i) => (
                <article
                  ...
                  style={{ background: item.bg, transitionDelay: `${i * 0.07}s` }}
                >
          ...
          <div className="container">
            <div className="section-head section-head--light reveal">
              ...
              <p className="section-intro section-intro--light">
                Pesan catering Lumbana cukup dari WhatsApp. Tidak perlu ribet.
              </p>
            </div>
        ...
        <section className="cta-banner">
          ...
          <div className="container cta-banner-inner reveal">
            ...
            <p>
              Hubungi kami sekarang untuk konsultasi menu gratis dan mendapatkan estimasi harga terbaik.
            </p>
            <div className="cta-group">
              <a className="btn btn-accent btn-lg" href={WA} target="_blank" rel="noopener noreferrer">
                <WaIcon /> Pesan via WhatsApp
              </a>
              <a className="btn btn-outline-white btn-lg" href={TEL}>
                📞 Telepon Kami
              </a>
            </div>
          </div>
